...
class FinalTable(models.Model):
    ...
    semantic_neu = models.DecimalField(null=True, max_digits=6, decimal_places=4)
    semantic_pos = models.DecimalField(null=True, max_digits=6, decimal_places=4)
    semantic_compound = models.DecimalField(null=True, default=0, max_digits=6, decimal_places=4)
...
class FinalTableAll(models.Model):
    entity = models.CharField(max_length=100)
    date = models.CharField(max_length=30)
    semantic_neg = models.DecimalField(null=True, max_digits=6, decimal_places=5)
    semantic_neu = models.DecimalField(null=True, max_digits=6, decimal_places=5)
    semantic_pos = models.DecimalField(null=True, max_digits=6, decimal_places=5)
